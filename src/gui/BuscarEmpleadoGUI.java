...
public class BuscarEmpleadoGUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INGRESE NOMBRE DEL EMPLEADO:");
    ...
    private void jtblRegistrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblRegistrosMouseClicked
        try {
            FacturaGUI.jtxtCodEmpleado.setText(jtblRegistros.getValueAt(jtblRegistros.getSelectedRow(), 0).toString());
            FacturaGUI.jtxtNombEmpleado.setText(jtblRegistros.getValueAt(jtblRegistros.getSelectedRow(), 1).toString());
            FacturaGUI.jtxtPaterno.setText(jtblRegistros.getValueAt(jtblRegistros.getSelectedRow(), 2).toString());
            FacturaGUI.jtxtMaterno.setText(jtblRegistros.getValueAt(jtblRegistros.getSelectedRow(), 3).toString());
            dispose();
        } catch (Exception e) {
        }
